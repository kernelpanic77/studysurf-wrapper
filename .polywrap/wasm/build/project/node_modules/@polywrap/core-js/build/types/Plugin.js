...
var PluginModule = /** @class */ (function () {
    ...
    PluginModule.prototype.setEnv = function (env) {
        this._env = env;
    };
    PluginModule.prototype._wrap_invoke = function (method, args, client) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!fn) {
                            return [2 /*return*/, result_1.ResultErr(Error("Plugin missing method \"" + method + "\""))];
                        }
                        if (typeof fn !== "function") {
                            return [2 /*return*/, result_1.ResultErr(Error("Plugin method \"" + method + "\" must be of type 'function'"))];
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, fn(args, client)];
                    case 2:
                        data = _a.sent();
                        return [2 /*return*/, result_1.ResultOk(data)];
                    case 3:
                        e_1 = _a.sent();
                        e_1.code = _1.WrapErrorCode.WRAPPER_INVOKE_ABORTED;
