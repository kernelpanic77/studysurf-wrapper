...
var HttpPlugin = /** @class */ (function (_super) {
    ...
    HttpPlugin.prototype.get = function (args, _client) {
    ...
    HttpPlugin.prototype.post = function (args, _client) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, axios_1.default.post(args.url, args.request ? args.request.body : undefined, args.request ? util_1.toAxiosRequestConfig(args.request) : undefined)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, util_1.fromAxiosResponse(response)];
                }
