...
exports.migrateAppManifest = void 0;
/* eslint-disable */
/**
...
function migrateAppManifest(manifest, to, logger) {
    var e_1, _a;
    var from = manifest.format;
    if (!(Object.values(_1.AppManifestFormats).some(function (x) { return x === from; }))) {
        throw new Error("Unrecognized AppManifestFormat \"" + manifest.format + "\"");
    }
    if (!(Object.values(_1.AppManifestFormats).some(function (x) { return x === to; }))) {
    ...
    if (!migrationPath) {
        throw new Error("Migration path from AppManifestFormat \"" + from + "\" to \"" + to + "\" is not available");
    }
...
exports.migrateAppManifest = migrateAppManifest;
