...
exports.migrateBuildManifest = void 0;
/* eslint-disable */
/**
...
function migrateBuildManifest(manifest, to, logger) {
    var e_1, _a;
    var from = manifest.format;
    if (!(Object.values(_1.BuildManifestFormats).some(function (x) { return x === from; }))) {
        throw new Error("Unrecognized BuildManifestFormat \"" + manifest.format + "\"");
    }
    if (!(Object.values(_1.BuildManifestFormats).some(function (x) { return x === to; }))) {
    ...
    if (!migrationPath) {
        throw new Error("Migration path from BuildManifestFormat \"" + from + "\" to \"" + to + "\" is not available");
    }
...
exports.migrateBuildManifest = migrateBuildManifest;
