...
exports.migrateDeployManifest = void 0;
/* eslint-disable */
/**
...
function migrateDeployManifest(manifest, to, logger) {
    var e_1, _a;
    var from = manifest.format;
    if (!(Object.values(_1.DeployManifestFormats).some(function (x) { return x === from; }))) {
        throw new Error("Unrecognized DeployManifestFormat \"" + manifest.format + "\"");
    }
    if (!(Object.values(_1.DeployManifestFormats).some(function (x) { return x === to; }))) {
    ...
    if (!migrationPath) {
        throw new Error("Migration path from DeployManifestFormat \"" + from + "\" to \"" + to + "\" is not available");
    }
...
exports.migrateDeployManifest = migrateDeployManifest;
