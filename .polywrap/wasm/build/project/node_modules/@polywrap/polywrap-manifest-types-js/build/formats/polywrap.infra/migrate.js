...
exports.migrateInfraManifest = void 0;
/* eslint-disable */
/**
...
function migrateInfraManifest(manifest, to, logger) {
    var e_1, _a;
    var from = manifest.format;
    if (!(Object.values(_1.InfraManifestFormats).some(function (x) { return x === from; }))) {
        throw new Error("Unrecognized InfraManifestFormat \"" + manifest.format + "\"");
    }
    if (!(Object.values(_1.InfraManifestFormats).some(function (x) { return x === to; }))) {
    ...
    if (!migrationPath) {
        throw new Error("Migration path from InfraManifestFormat \"" + from + "\" to \"" + to + "\" is not available");
    }
...
exports.migrateInfraManifest = migrateInfraManifest;
