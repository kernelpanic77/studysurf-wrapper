...
exports.migrateMetaManifest = void 0;
/* eslint-disable */
/**
...
function migrateMetaManifest(manifest, to, logger) {
    var e_1, _a;
    var from = manifest.format;
    if (!(Object.values(_1.MetaManifestFormats).some(function (x) { return x === from; }))) {
        throw new Error("Unrecognized MetaManifestFormat \"" + manifest.format + "\"");
    }
    if (!(Object.values(_1.MetaManifestFormats).some(function (x) { return x === to; }))) {
    ...
    if (!migrationPath) {
        throw new Error("Migration path from MetaManifestFormat \"" + from + "\" to \"" + to + "\" is not available");
    }
...
exports.migrateMetaManifest = migrateMetaManifest;
