...
exports.migratePluginManifest = void 0;
/* eslint-disable */
/**
...
function migratePluginManifest(manifest, to, logger) {
    var e_1, _a;
    var from = manifest.format;
    if (!(Object.values(_1.PluginManifestFormats).some(function (x) { return x === from; }))) {
        throw new Error("Unrecognized PluginManifestFormat \"" + manifest.format + "\"");
    }
    if (!(Object.values(_1.PluginManifestFormats).some(function (x) { return x === to; }))) {
    ...
    if (!migrationPath) {
        throw new Error("Migration path from PluginManifestFormat \"" + from + "\" to \"" + to + "\" is not available");
    }
...
exports.migratePluginManifest = migratePluginManifest;
