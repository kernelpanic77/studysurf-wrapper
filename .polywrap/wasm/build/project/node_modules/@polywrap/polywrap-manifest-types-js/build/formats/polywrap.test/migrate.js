...
exports.migratePolywrapWorkflow = void 0;
/* eslint-disable */
/**
...
function migratePolywrapWorkflow(manifest, to, logger) {
    var e_1, _a;
    var from = manifest.format;
    if (!(Object.values(_1.PolywrapWorkflowFormats).some(function (x) { return x === from; }))) {
        throw new Error("Unrecognized PolywrapWorkflowFormat \"" + manifest.format + "\"");
    }
    if (!(Object.values(_1.PolywrapWorkflowFormats).some(function (x) { return x === to; }))) {
    ...
    if (!migrationPath) {
        throw new Error("Migration path from PolywrapWorkflowFormat \"" + from + "\" to \"" + to + "\" is not available");
    }
...
exports.migratePolywrapWorkflow = migratePolywrapWorkflow;
