...
var toLower = function (type) { return __1.Functions.toLower()(type, function (str) { return str; }); };
var generateBinding = function (options) {
    ...
    if (abi.objectTypes) {
        try {
            for (var _j = __values(abi.objectTypes), _k = _j.next(); !_k.done; _k = _j.next()) {
                ...
                output.entries.push({
                    type: "Directory",
                    name: __1.Functions.detectKeyword()(toLower(objectType.type), function (str) { return str; }),
    ...
    if (abi.envType) {
        output.entries.push({
            type: "Directory",
            name: __1.Functions.detectKeyword()(toLower(abi.envType.type), function (str) { return str; }),
    ...
    if (abi.importedEnumTypes) {
        try {
            for (var _o = __values(abi.importedEnumTypes), _p = _o.next(); !_p.done; _p = _o.next()) {
                var importedEnumType = _p.value;
                importEntries.push({
                    type: "Directory",
                    name: __1.Functions.detectKeyword()(toLower(importedEnumType.type), function (str) { return str; }),
    ...
    if (abi.importedObjectTypes) {
        try {
            for (var _q = __values(abi.importedObjectTypes), _r = _q.next(); !_r.done; _r = _q.next()) {
                var importedObectType = _r.value;
                importEntries.push({
                    type: "Directory",
                    name: __1.Functions.detectKeyword()(toLower(importedObectType.type), function (str) { return str; }),
    ...
    if (abi.importedEnvTypes) {
        try {
            for (var _s = __values(abi.importedEnvTypes), _t = _s.next(); !_t.done; _t = _s.next()) {
                var importedEnvType = _t.value;
                importEntries.push({
                    type: "Directory",
                    name: __1.Functions.detectKeyword()(toLower(importedEnvType.type), function (str) { return str; }),
    ...
    if (abi.moduleType) {
        output.entries.push({
            ...
            data: __2.renderTemplates(templatePath("module-type"), abi, subTemplates),
        });
    }
    ...
    if (abi.enumTypes) {
        try {
            for (var _w = __values(abi.enumTypes), _x = _w.next(); !_x.done; _x = _w.next()) {
                ...
                output.entries.push({
                    type: "Directory",
                    name: __1.Functions.detectKeyword()(toLower(enumType.type), function (str) { return str; }),
