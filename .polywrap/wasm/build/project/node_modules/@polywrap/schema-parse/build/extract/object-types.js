...
var visitorEnter = function (objectTypes, state) { return ({
    ObjectTypeDefinition: function (node) {
        ...
        if (__1.isModuleType(typeName) || __1.isEnvType(typeName)) {
            return;
        }
        // Skip imported types
        if (node.directives &&
        ...
        var type = __1.createObjectDefinition({
            type: typeName,
...
var getObjectTypesVisitor = function (abi) {
    var state = {};
    return {
...
exports.getObjectTypesVisitor = getObjectTypesVisitor;
