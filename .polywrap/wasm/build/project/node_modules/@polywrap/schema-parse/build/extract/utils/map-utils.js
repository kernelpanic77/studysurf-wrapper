...
exports.appendNamespace = exports.toGraphQLType = exports.parseMapType = exports.parseCurrentType = void 0;
var __1 = require("../..");
...
var _toGraphQLType = function (rootType, type) {
    ...
    switch (currentType) {
        ...
        case "Map": {
            ...
            return "Map<" + _toGraphQLType(rootType, keyType) + ", " + _toGraphQLType(rootType, valType) + ">";
        }
        default:
            throw new Error("Found unknown type " + currentType + " while parsing " + rootType);
    }
};
var _appendNamespace = function (namespace, rootType, type) {
    var parsedCurrentType = _parseCurrentType(rootType, type);
    var subType = parsedCurrentType.subType;
    var currentType = parsedCurrentType.currentType;
    if (!subType) {
        return __1.isScalarType(currentType)
            ? currentType
    ...
    switch (currentType) {
        ...
        case "Map": {
            ...
            var keyType = subType.substring(0, firstDelimiter).trim();
            var valType = subType.substring(firstDelimiter + 1).trim();
            return "Map<" + _appendNamespace(namespace, rootType, keyType) + ", " + _appendNamespace(namespace, rootType, valType) + ">";
        }
        default:
            throw new Error("Found unknown type " + currentType + " while parsing " + rootType);
    }
...
var _parseMapType = function (rootType, type, name) {
    ...
    if (!subType) {
        if (__1.isScalarType(currentType)) {
            return __1.createScalarDefinition({
                name: name,
                type: currentType,
                required: required,
            });
        }
        return __1.createUnresolvedObjectOrEnumRef({
            name: name,
            type: currentType,
            required: required,
        });
    ...
    switch (currentType) {
        case "Array": {
            return __1.createArrayDefinition({
                name: name,
        ...
        case "Map": {
            ...
            if (!__1.isMapKeyType(keyType)) {
                throw new Error("Found invalid map key type: " + keyType + " while parsing " + rootType);
            }
            return __1.createMapDefinition({
                type: _toGraphQLType(rootType, type),
                name: name,
                key: __1.createMapKeyDefinition({
                    name: name,
                    type: keyType,
...
function appendNamespace(namespace, type) {
    return _appendNamespace(namespace, type, type);
}
exports.appendNamespace = appendNamespace;
