import { Uri, Client, IUriResolver, IUriResolutionContext, UriPackageOrWrapper } from "@polywrap/core-js";
...
export declare class ExtendableUriResolver extends UriResolverAggregatorBase<Error, Error> {
    ...
    getUriResolvers(uri: Uri, client: Client, resolutionContext: IUriResolutionContext): Promise<Result<IUriResolver<unknown>[], Error>>;
