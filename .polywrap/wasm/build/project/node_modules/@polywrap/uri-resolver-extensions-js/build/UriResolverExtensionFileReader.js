...
var UriResolverExtensionFileReader = /** @class */ (function () {
    function UriResolverExtensionFileReader(resolverExtensionUri, wrapperUri, client) {
        this.resolverExtensionUri = resolverExtensionUri;
    ...
    UriResolverExtensionFileReader.prototype.readFile = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = core_js_1.combinePaths(this.wrapperUri.path, filePath);
                        return [4 /*yield*/, core_js_1.UriResolverInterface.module.getFile({
                                invoke: function (options) {
                                    return _this.client.invoke(options);
                                },
                                invokeWrapper: function (options) {
                                    return _this.client.invokeWrapper(options);
                                },
                            }, this.resolverExtensionUri, path)];
                    case 1:
                        result = _a.sent();
                        if (!result.ok)
                            return [2 /*return*/, result];
                        if (!result.value) {
                            return [2 /*return*/, result_1.ResultErr(new Error("File not found at " + path))];
                        }
                        return [2 /*return*/, {
                                value: result.value,
                                ok: true,
