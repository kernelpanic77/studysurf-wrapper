import { Uri, Client, IUriResolutionContext, UriPackageOrWrapper } from "@polywrap/core-js";
...
export declare class UriResolverWrapper extends ResolverWithHistory<unknown> {
    ...
    protected _tryResolveUri(uri: Uri, client: Client, resolutionContext: IUriResolutionContext): Promise<Result<UriPackageOrWrapper, unknown>>;
}
