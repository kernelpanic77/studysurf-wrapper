...
exports.InMemoryFileReader = void 0;
var constants_1 = require("./constants");
var result_1 = require("@polywrap/result");
var InMemoryFileReader = /** @class */ (function () {
    function InMemoryFileReader() {
    }
    InMemoryFileReader.fromManifest = function (manifest, baseFileReader) {
        return {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        if (filePath === constants_1.WRAP_MANIFEST_PATH) {
                            ...
                            return [2 /*return*/, baseFileReader.readFile(filePath)];
                        }
                        return [2 /*return*/];
                    });
                });
    ...
    InMemoryFileReader.fromWasmModule = function (wasmModule, baseFileReader) {
        return {
            readFile: function (filePath) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
    ...
    InMemoryFileReader.from = function (manifest, wasmModule, baseFileReader) {
        return {
            readFile: function (filePath) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
...
//# sourceMappingURL=InMemoryFileReader.js.map