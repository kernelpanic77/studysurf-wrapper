...
var WasmPackage = /** @class */ (function () {
    ...
    WasmPackage.prototype.getWasmModule = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
    ...
    WasmPackage.prototype.createWrapper = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getManifest(options)];
                    case 1:
                        result = _a.sent();
                        if (!result.ok) {
                            return [2 /*return*/, result];
...
//# sourceMappingURL=WasmPackage.js.map