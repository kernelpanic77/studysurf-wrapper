...
var generateBinding = function (options) {
    ...
    // generate modules
    if (abi.moduleType) {
        var module_1 = abi.moduleType;
        renderTemplate("./templates/jsdoc-module.mustache", module_1, module_1.type.toLowerCase() + ".js");
    }
    ...
    if ((_e = options.config) === null || _e === void 0 ? void 0 : _e["imports"]) {
        ...
        if (abi.importedModuleTypes) {
            try {
                for (var _f = __values(abi.importedModuleTypes), _g = _f.next(); !_g.done; _g = _f.next()) {
                    ...
                    var moduleContext = __assign(__assign({}, module_2), { imported: { namespace: module_2.namespace } });
                    renderTemplate("./templates/jsdoc-module.mustache", moduleContext, module_2.type + ".js");
                }
            }
        ...
        if (abi.importedObjectTypes) {
            var importedObjects = sortByNamespace(abi.importedObjectTypes);
            try {
                for (var _h = __values(Object.entries(importedObjects)), _j = _h.next(); !_j.done; _j = _h.next()) {
                    ...
                    if (objectTypes.length > 0) {
                        ...
                        renderTemplate("./templates/jsdoc-objects.mustache", objectContext, namespace + "_objects.js");
                    }
                }
            }
        ...
        if (abi.importedEnumTypes) {
            var importedEnums = sortByNamespace(abi.importedEnumTypes);
            try {
                for (var _l = __values(Object.entries(importedEnums)), _m = _l.next(); !_m.done; _m = _l.next()) {
                    ...
                    if (enumTypes.length > 0) {
                        ...
                        renderTemplate("./templates/jsdoc-enums.mustache", enumContext, namespace + "_enums.js");
                    }
                }
            }
            ...
            try {
                for (var _p = __values(Object.entries(importedEnvs)), _q = _p.next(); !_q.done; _q = _p.next()) {
                    ...
                    if (envType) {
                        ...
                        renderTemplate("./templates/jsdoc-env.mustache", envContext, namespace + "_env.js");
                    }
                }
            }
...
function sortByNamespace(definitions) {
    var e_6, _a;
    var result = {};
    try {
