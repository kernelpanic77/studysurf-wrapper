...
exports.loadPluginManifest = exports.defaultPluginManifest = void 0;
var __1 = require("../../../");
var polywrap_manifest_types_js_1 = require("@polywrap/polywrap-manifest-types-js");
var fs_1 = __importDefault(require("fs"));
exports.defaultPluginManifest = [
    "polywrap.plugin.yaml",
    "polywrap.plugin.yml",
];
function loadPluginManifest(manifestPath, logger) {
            ...
            switch (_a.label) {
                case 0:
                    run = function () {
                        ...
                        try {
                            var result = polywrap_manifest_types_js_1.deserializePluginManifest(manifest, { logger: logger });
